...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/Classic_Uno.loader.js";
var config = {
  dataUrl: buildUrl + "/Classic_Uno.data",
  frameworkUrl: buildUrl + "/Classic_Uno.framework.js",
  codeUrl: buildUrl + "/Classic_Uno.wasm",
  streamingAssetsUrl: "StreamingAssets",
  companyName: "Gamebol",
  productName: "Classic Uno",
  productVersion: "1.0",
};
