  ...
  function n(l) {
    function E(N) {
      return g(N, function (J, I) {
        ...
        !J &&
          (J =
            RegExp("\\b" + O + " *\\d+[.\\w_]*", "i").exec(l) ||
            RegExp("\\b" + O + " *\\w+-[\\w]*", "i").exec(l) ||
            RegExp(
              "\\b" + O + "(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)",
              "i"
            ).exec(l)) &&
          ((J = String(
            I.label && !RegExp(O, "i").test(I.label) ? I.label : J
          ).split("/"))[1] &&
            !/[\d.]+/.test(J[0]) &&
            (J[0] += " " + J[1]),
          (I = I.label || I),
    ...
    var G = (function (N) {
        return g(N, function (J, I) {
          return (
            J ||
            (RegExp("\\b" + (I.pattern || k(I)) + "\\b", "i").exec(l) &&
              (I.label || I))
          );
        });
      })([
    ...
    "IE" == B && /\blike iPhone OS\b/.test(l)
      ? ((q = n(l.replace(/like iPhone OS/, ""))),
        (P = q.manufacturer),
        (H = q.product))
      : /^iP/.test(H)
      ? (B || (B = "Safari"),
        (C =
          "iOS" +
          ((q = / OS ([\d_]+)/i.exec(l)) ? " " + q[1].replace(/_/g, ".") : "")))
      : "Konqueror" != B || /buntu/i.test(C)
      ? (P &&
          "Google" != P &&
          ((/Chrome/.test(B) && !/\bMobile Safari\b/i.test(l)) ||
            /\bVita\b/.test(H))) ||
        (/\bAndroid\b/.test(C) && /^Chrome/.test(B) && /\bVersion\//i.test(l))
        ? ((B = "Android Browser"), (C = /\bAndroid\b/.test(C) ? C : "Android"))
        : "Silk" == B
        ? (/\bMobi/i.test(l) || ((C = "Android"), u.unshift("desktop mode")),
          /Accelerated *= *true/i.test(l) && u.unshift("accelerated"))
        : "PaleMoon" == B && (q = /\bFirefox\/([\d.]+)\b/.exec(l))
        ? u.push("identifying as Firefox " + q[1])
        : "Firefox" == B && (q = /\b(Mobile|Tablet|TV)\b/i.exec(l))
        ? (C || (C = "Firefox OS"), H || (H = q[1]))
        : !B ||
          (q = !/\bMinefield\b/i.test(l) && /\b(?:Firefox|Safari)\b/.exec(B))
        ? (B &&
            !H &&
            /[\/,]|^[^(]+?\)/.test(l.slice(l.indexOf(q + "/") + 8)) &&
            (B = null),
          (q = H || P || C) &&
            (H || P || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(C)) &&
            (B =
              /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(C) ? C : q) +
              " Browser"))
        : "Electron" == B &&
          (q = (/\bChrome\/([\d.]+)\b/.exec(l) || 0)[1]) &&
          u.push("Chromium " + q)
      : (C = "Kubuntu");
    A ||
      (A = F([
    ...
    if (
      (q =
        ...
        (/\bOpera\b/.test(B) && (/\bOPR\b/.test(l) ? "Blink" : "Presto")) ||
        (/\b(?:Midori|Nook|Safari)\b/i.test(l) &&
          !/^(?:Trident|EdgeHTML)$/.test(G) &&
          "WebKit") ||
        (!G && /\bMSIE\b/i.test(l) && ("Mac OS" == C ? "Tasman" : "Trident")) ||
        ("WebKit" == G && /\bPlayStation\b(?! Vita\b)/i.test(B) && "NetFront"))
    )
      G = [q];
    "IE" == B && (q = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(l) || 0)[1])
      ? ((B += " Mobile"),
        (C = "Windows Phone " + (/\+$/.test(q) ? q : q + ".x")),
        u.unshift("desktop mode"))
      : /\bWPDesktop\b/i.test(l)
      ? ((B = "IE Mobile"),
        (C = "Windows Phone 8.x"),
        u.unshift("desktop mode"),
        A || (A = (/\brv:([\d.]+)/.exec(l) || 0)[1]))
      : "IE" != B &&
        "Trident" == G &&
        (q = /\brv:([\d.]+)/.exec(l)) &&
        (B && u.push("identifying as " + B + (A ? " " + A : "")),
        (B = "IE"),
        (A = q[1]));
    if (T) {
      if (e(w, "global"))
        if (
          (Q &&
            ...
            (C =
              C ||
              q.getProperty("os.name") + " " + q.getProperty("os.version"))),
          M)
        ) {
          try {
            ...
            (q = w.system) &&
              q.global.system == w.system &&
              ((B = "Narwhal"), C || (C = q[0].os || null));
          }
          B || (B = "Rhino");
        } else
          "object" == typeof w.process &&
            !w.process.browser &&
            (q = w.process) &&
            ("object" == typeof q.versions &&
              ("string" == typeof q.versions.electron
                ? (u.push("Node " + q.versions.node),
                  (B = "Electron"),
                  (A = q.versions.electron))
                : "string" == typeof q.versions.nw &&
                  (u.push("Chromium " + A, "Node " + q.versions.node),
                  (B = "NW.js"),
                  (A = q.versions.nw))),
            B ||
              ((B = "Node.js"),
        ...
        d((q = w.runtime)) == L
          ? ((B = "Adobe AIR"), (C = q.flash.system.Capabilities.os))
          : d((q = w.phantom)) == U
          ? ((B = "PhantomJS"),
            (A =
              (q = q.version || null) &&
          ...
          : "number" == typeof Y.documentMode &&
            (q = /\bTrident\/(\d+)/i.exec(l))
          ? ((A = [A, Y.documentMode]),
            (q = +q[1] + 4) != A[1] &&
              (u.push("IE " + A[1] + " mode"), G && (G[1] = ""), (A[1] = q)),
            (A = "IE" == B ? String(A[1].toFixed(1)) : A[0]))
          : "number" == typeof Y.documentMode &&
            /^(?:Chrome|Firefox)\b/.test(B) &&
            (u.push("masking as " + B + " " + A),
            (B = "IE"),
            (A = "11.0"),
            (G = ["Trident"]),
            (C = "Windows"));
    ...
    A &&
      (q =
        ...
        /(?:alpha|beta)(?: ?\d)?/i.exec(l + ";" + (T && D.appMinorVersion)) ||
        (/\bMinefield\b/i.test(l) && "a")) &&
      ((X = /b/i.test(q) ? "beta" : "alpha"),
      (A =
        A.replace(RegExp(q + "\\+?$"), "") +
        ("beta" == X ? da : ca) +
        (/\d+\+?/.exec(q) || "")));
    if (
      "Fennec" == B ||
      ("Firefox" == B && /\b(?:Android|Firefox OS)\b/.test(C))
    )
      B = "Firefox Mobile";
    else if ("Maxthon" == B && A) A = A.replace(/\.[\d.]+/, ".x");
    else if (/\bXbox\b/i.test(H))
      "Xbox 360" == H && (C = null),
        "Xbox 360" == H && /\bIEMobile\b/.test(l) && u.unshift("mobile mode");
    else if (
      (!/^(?:Chrome|IE|Opera)$/.test(B) &&
        (!B || H || /Browser|Mobi/.test(B))) ||
      ("Windows CE" != C && !/Mobi/i.test(l))
    )
      if ("IE" == B && T)
        try {
          null === w.external && u.unshift("platform preview");
        } catch (N) {
          u.unshift("embedded");
        }
      else
        (/\bBlackBerry\b/.test(H) || /\bBB10\b/.test(l)) &&
        (q =
          (RegExp(H.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(l) ||
            0)[1] || A)
          ? ((q = [q, /BB10/.test(l)]),
            (C =
              (q[1] ? ((H = null), (P = "BlackBerry")) : "Device Software") +
              " " +
              q[0]),
            (A = null))
          : this != f &&
            "Wii" != H &&
            ((T && S) ||
              (/Opera/.test(B) && /\b(?:MSIE|Firefox)\b/i.test(l)) ||
              ("Firefox" == B && /\bOS X (?:\d+\.){2,}/.test(C)) ||
              ("IE" == B &&
                ((C && !/^Win/.test(C) && 5.5 < A) ||
                  (/\bWindows XP\b/.test(C) && 8 < A) ||
                  (8 == A && !/\bTrident\b/.test(l))))) &&
            !x.test((q = n.call(f, l.replace(x, "") + ";"))) &&
            q.name &&
            ((q = "ing as " + q.name + ((q = q.version) ? " " + q : "")),
            x.test(B)
              ? (/\bIE\b/.test(q) && "Mac OS" == C && (C = null),
                (q = "identify" + q))
              : ((q = "mask" + q),
                (B = V ? c(V.replace(/([a-z])([A-Z])/g, "$1 $2")) : "Opera"),
                /\bIE\b/.test(q) && (C = null),
                T || (A = null)),
            (G = ["Presto"]),
            u.push(q));
    ...
    if ((q = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(l) || 0)[1])) {
      ...
      G &&
        (G[1] +=
          " " + (q += "number" == typeof q ? ".x" : /[.+]/.test(q) ? "" : "+"));
      "Safari" == B && (!A || 45 < parseInt(A)) && (A = q);
    }
    "Opera" == B && (q = /\bzbov|zvav$/.exec(C))
      ? ((B += " "),
        u.unshift("desktop mode"),
        "zvav" == q ? ((B += "Mini"), (A = null)) : (B += "Mobile"),
        (C = C.replace(RegExp(" *" + q + "$"), "")))
      : "Safari" == B &&
        /\bChrome\b/.exec(G && G[1]) &&
        (u.unshift("desktop mode"),
        (B = "Chrome Mobile"),
        (A = null),
        /\bOS X\b/.test(C) ? ((P = "Apple"), (C = "iOS 4.3+")) : (C = null));
    A &&
      0 == A.indexOf((q = /[\d.]+$/.exec(C))) &&
      -1 < l.indexOf("/" + q + "-") &&
      (C = String(C.replace(q, "")).replace(/^ +| +$/g, ""));
    G &&
      !/\b(?:Avant|Nook)\b/.test(B) &&
      (/Browser|Lunascape|Maxthon/.test(B) ||
        ("Safari" != B && /^iOS/.test(C) && /\bSafari\b/.test(G[1])) ||
    ...
    H && u.push((/^on /.test(u[u.length - 1]) ? "" : "on ") + H);
    if (C) {
      var ba =
        (q = / ([\d.+]+)$/.exec(C)) &&
        "/" == C.charAt(C.length - q[0].length - 1);
      C = {
        architecture: 32,
    ...
    (q = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(W)) && !/\bi686\b/i.test(W)
      ? (C &&
          ((C.architecture = 64),
          (C.family = C.family.replace(RegExp(" *" + q), ""))),
        B &&
          (/\bWOW64\b/i.test(l) ||
            (T &&
    ...
    C &&
      B &&
      (C != String(C).split(" ")[0] || (C != B.split(" ")[0] && !H)) &&
      u.push(H ? "(" + C + ")" : "on " + C);
...
function sizeHandler() {
  ...
  if ($("#canvas")) {
    ...
    if (c < a) {
      ...
      f < b &&
        ((d = b - f), (f += d), (c += (CANVAS_HEIGHT / CANVAS_WIDTH) * d));
    d = a / 2 - c / 2;
    var e = b / 2 - f / 2,
      k = CANVAS_WIDTH / f;
    if (e * k < -EDGEBOARD_X || d * k < -EDGEBOARD_Y)
      (c = Math.min(
...
function calculateIntersection(a, b) {
  ...
  g = Math.abs(g - m) - (f + e);
  return 0 > k && 0 > g
    ? ((k = Math.min(Math.min(a.width, b.width), -k)),
      (g = Math.min(Math.min(a.height, b.height), -g)),
      {
        x: Math.max(a.x, b.x),
        y: Math.max(a.y, b.y),
        width: k,
...
function getBounds(a, b) {
  ...
  if (a instanceof createjs.Container) {
    ...
    c.x = Math.min(Math.min(Math.min(d.x, k.x), e.x), f.x);
...
(function () {
  function a(c) {
    ...
    c = c || window.event;
    c.type in f
      ? (document.body.className = f[c.type])
...
function CTextButton(a, b, c, f, d, e, k, g) {
  ...
  this._init = function (F, w, u, D, A, K, L, M) {
    ...
    l.lineWidth = 0.9 * m;
    l.x = u.width / 2;
    l.y = Math.floor(u.height / 2) + U.height / 3;
  ...
  this.disable = function () {
    n = !0;
    var F = new createjs.ColorMatrix()
...
CTLText.prototype = {
  ...
  setPos: function (a, b) {
    ...
    if (this._bDebug) {
      ...
      this._oDebugShape.graphics
        .beginFill("rgba(255,0,0,0.5)")
        .drawRect(c, 0, this._iWidth, this._iHeight);
      this._oDebugShape.x = this._x;
      this._oDebugShape.y = this._y;
      this._oContainer.addChild(this._oDebugShape);
    }
  ...
  function a(d) {
    ...
    for (p = 0; p < n; p++)
      if ("string" === typeof e[p]) r += e[p];
        ...
        c.not_type.test(h.type) &&
          c.not_primitive.test(h.type) &&
        ...
        switch (h.type) {
          ...
          case "e":
            m = h.precision
              ? parseFloat(m).toExponential(h.precision)
              : parseFloat(m).toExponential();
            break;
          case "f":
            m = h.precision
              ? parseFloat(m).toFixed(h.precision)
              : parseFloat(m);
            break;
          case "g":
            m = h.precision
              ? String(Number(m.toPrecision(h.precision)))
              : parseFloat(m);
            break;
          case "o":
...
function CButLang(a, b, c, f, d, e) {
  ...
  this._onChangeLang = function () {
    ...
    g[ON_SELECT_LANG] && g[ON_SELECT_LANG].call(n[ON_SELECT_LANG], k);
  };
  this.getButtonImage = function () {
    return h;
  };
...
function CPreloader() {
  ...
  this.refreshLoader = function (m) {
    c.text = m + "%";
    100 === m &&
      (s_oMain.onRemovePreloader(), (c.visible = !1), (f.visible = !1));
    d.graphics.clear();
...
function CPanelTutorial() {
  ...
  this.init = function () {
    ...
    f = new CGfxButton(-(a.getBounds().width / 2 - 50), 0, g, a);
...
function CTurnManager() {
  ...
  this.nextTurn = function () {
    !0 === a
      ? (d.next(), (c = d.current()), (b = d.getNext()))
      : (d.prev(), (c = d.current()), (b = d.getPrev()));
  };
  this.prevTurn = function () {
    !0 === a
      ? (d.prev(), (c = d.current()), (b = d.getNext()))
      : (d.next(), (c = d.current()), (b = d.getPrev()));
  };
  ...
  this.removePlayer = function (e) {
    e === c
      ? (a ? this.prevTurn() : this.nextTurn(), d.removeElement(e))
      : (d.removeElement(e), d.setCurrent(c));
  };
  this.init();
}
s_oTurnManager = null;
...
function CMenu() {
  ...
  this._init = function () {
    ...
    !1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile
      ? ((z = s_oSpriteLibrary.getSprite("audio_icon")),
        (d = CANVAS_WIDTH - z.height / 2 - 10),
        (e = z.height / 2 + 10),
        (p = new CToggle(d, e, z, s_bAudioActive, s_oStage)),
        p.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this),
        (a = d - l.width / NUM_LANGUAGES - 10),
        (b = e - 6))
      : ((a = CANVAS_WIDTH - z.width / 4 - 10), (b = z.height / 2 + 10));
    ...
    y &&
      ...
      (c = k),
      (f = g),
      (x = new CToggle(c, f, z, s_bFullscreen, s_oStage)),
      x.addEventListener(
        ON_MOUSE_UP,
        () => {
  ...
  this.refreshButtonPos = function () {
    (!1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile) ||
      p.setPosition(d - s_iOffsetX, s_iOffsetY + e);
...
function CSelectPlayers() {
  ...
  this._init = function () {
    ...
    !1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile
      ? ((l = s_oSpriteLibrary.getSprite("audio_icon")),
        (v = new CToggle(k, g, l, s_bAudioActive, s_oStage)),
        v.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this),
        (a = k - E.width / NUM_LANGUAGES - 10),
        (b = g - 6))
      : ((a = CANVAS_WIDTH - l.width / 4 - 10), (b = l.height / 2 + 10));
    ...
    x &&
      ...
      (d = l.width / 4 + 10),
      (e = l.height / 2 + 10),
      (t = new CToggle(d, e, l, s_bFullscreen, s_oStage)),
      t.addEventListener(ON_MOUSE_UP, this._onFullscreen, this));
    this.refreshButtonPos();
  };
  ...
  this.refreshButtonPos = function () {
    ...
    (!1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile) ||
      v.setPosition(k - s_iOffsetX, s_iOffsetY + g);
...
function CCard(a, b, c, f, d, e, k, g) {
  ...
  this.moveCard = function (u, D, A, K, L) {
    var M = this;
...
function CDeckDisplayer(a, b, c, f) {
  ...
  this.initializeDeck = function () {
    ...
    for (x = 0; 4 > x; x++)
      for (y = 0; 9 > y; y++)
        (p = y + 1),
          (t = 13 * x + p),
          d.push(new CCard(0, 0, e, t, p, x, h++, 0));
    for (x = 0; 4 > x; x++)
      for (y = 0; 2 > y; y++)
        d.push(new CCard(0, 0, e, 13 * x + 10, 10, x, h++, 0)),
          d.push(new CCard(0, 0, e, 13 * x + 11, 11, x, h++, 0)),
          d.push(new CCard(0, 0, e, 13 * x + 12, 12, x, h++, 0));
    for (x = 0; 4 > x; x++)
      d.push(new CCard(0, 0, e, FOTOGRAM_COLOR, 13, 4, h++, 0)),
        d.push(new CCard(0, 0, e, FOTOGRAM_DRAW_FOUR, 14, 4, h++, 0));
  };
  ...
  this.moveContainer = function (p, h, t, x) {
...
function CHandDisplayer(a, b, c, f, d, e, k, g) {
  ...
  this.setPosition = function (w, u, D, A, K) {
    m = w;
    r = u;
    t.x = D;
    t.y = A;
  ...
  this.searchIndexCard = function (w) {
    for (var u = 0; u < h.length; u++) if (w === h[u]) return u;
  };
  ...
  this.pushCard = function (w) {
    ...
    if (0 === r && t.y > CANVAS_HEIGHT / 2)
      h[h.length - 1].getCardSprite().on("mouseover", this.onMouseOver);
  };
  this.getContainer = function () {
    return t;
  };
  ...
  this.organizeHand = function (w) {
    ...
    if (0 !== m)
      for (w = 0; w < h.length; w++) {
        ...
        D *= w;
        createjs.Tween.get(h[w].getSprite())
          .to(
            {
              x: D,
            },
  ...
  this.getDynamicOffset = function (w) {
    var u = w;
    6 < h.length && (u = linearFunction(h.length, 7, 20, w, 0.55 * w));
    return u;
  };
...
CGameBase.prototype._init = function () {
  ...
  for (var b = 0; b < NUM_PLAYERS; b++) {
    var c = 0,
      f = 0;
    HAND_POS["num_player_" + NUM_PLAYERS][b].x === CANVAS_WIDTH / 2
      ? (c = CARD_WIDTH / 2)
      : (f = CARD_HEIGHT / 4);
    this._aPlayersHand[b] = new CHandDisplayer(
      c,
      f,
      HAND_POS["num_player_" + NUM_PLAYERS][b].x,
      HAND_POS["num_player_" + NUM_PLAYERS][b].y,
      b,
      this._oHandsContainer,
      a[b],
      HAND_POS["num_player_" + NUM_PLAYERS][b].side
    );
  }
...
CGameBase.prototype.onCardDealed = function (a) {
  ...
  this._aPlayersHand[b].pushCard(
    new CCard(
      this._aPlayersHand[b].getPosNewCard().x,
      this._aPlayersHand[b].getPosNewCard().y,
      this._aPlayersHand[b].getContainer(),
      a.getFotogram(),
      a.getRank(),
      a.getSuit(),
      a.getUniqueID(),
...
CGameBase.prototype.drawCardsTween = function (a, b, c, f) {
  ...
  createjs.Tween.get(n.getSprite())
    .wait(c)
    .to(
      {
        x: m,
    ...
    .call(function () {
      g._aPlayersHand[a].pushCard(
        new CCard(
          g._aPlayersHand[a].getPosNewCard().x,
          g._aPlayersHand[a].getPosNewCard().y,
          g._aPlayersHand[a].getContainer(),
          n.getFotogram(),
          n.getRank(),
          n.getSuit(),
          n.getUniqueID(),
...
CGameBase.prototype.checkForMoreDraws = function (a, b, c, f) {
  0 === this._oDeck.getLength()
    ? this.shuffleCards(a, b, c, f)
    : (this._iCounterDraw--,
      0 < this._iCounterDraw
        ? this.drawCardsTween(a, b, c, f)
        : this._onAllCardsDrawCompleted(a, f));
};
...
CGameBase.prototype._showAllPlayersMatchScore = function () {
  for (var a = 0; a < this._aPlayersHand.length; a++) {
    ...
    0 < this._aPlayersHand[a].getLength()
      ? this._aPlayersHand[a].showHandScore(sprintf(TEXT_PTS_TO_WINNER, b))
...
CGameBase.prototype._checkUnoNotify = function (a, b, c) {
  a &&
    (c === b
      ...
      : ((a = this._aPlayersHand[c].getName().toUpperCase()),
...
CGameSingle.prototype.playCard = function (a, b) {
  ...
  f &&
    ...
    (c = this._aPlayersHand[c].getContainerPos()),
    (f = this._oUsedCards.getGlobalPosition()),
    playSound("card", 1, !1),
    a.moveCard(f.x - c.x, f.y - c.y, 0, 300),
    a.showCard(),
    this._oUsedCards.setChildDepth(2));
};
...
CGameSingle.prototype.shuffleCards = function (a, b, c, f) {
  for (
    var d = this,
      e = this._oUsedCards.removeAllCardUnderTheDeck(),
      k = [],
      g = 0;
    g < e.length;
    g++
...
function CInterface() {
  ...
  this._init = function () {
    ...
    if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile)
      (y = s_oSpriteLibrary.getSprite("audio_icon")),
        (n = new CToggle(c, f, y, s_bAudioActive, x)),
    ...
    h &&
      ...
      (a = y.width / 4 + 10),
      (b = y.height / 2 + 10),
      (r = new CToggle(a, b, y, s_bFullscreen, x)),
      r.addEventListener(ON_MOUSE_UP, this._onFullscreen, this));
  ...
  this.refreshButtonPos = function () {
    m.setPosition(d - s_iOffsetX, s_iOffsetY + e);
    (!1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile) ||
  ...
  this.resetFullscreenBut = function () {
    h && screenfull.isEnabled && r.setActive(s_bFullscreen);
  };
  this._onFullscreen = function () {
    s_bFullscreen
...
function CSelectColorPanel(a) {
  ...
  this.onSelectColor = function (h) {
    ...
    g.disableButtons();
    c[ON_COLOR_SELECTED] &&
      c[ON_COLOR_SELECTED].call(f[ON_COLOR_SELECTED], h, a);
  };
  g = this;
  this._init();
}
function CAreYouSurePanel(a) {
  ...
  this._init = function (g) {
    ...
    f = new CGfxButton(-110, 80, s_oSpriteLibrary.getSprite("but_exit_big"), e);
...
function CAIManager() {
  ...
  this.selectACard = function (a) {
    for (
      var b = s_oGame.getPlayersHand(a),
        c = s_oGame.getCurColor(),
        f = s_oGame.getLastCard(),
        d = [],
        e = 0;
      e < b.getLength();
      e++
    )
      4 === b.getCardByIndex(e).getSuit() ||
      (b.getCardByIndex(e).getRank() !== f.getRank() &&
        b.getCardByIndex(e).getSuit() !== c)
        ? b.getCardByIndex(e).getFotogram() === FOTOGRAM_COLOR
          ? d.push({
              oCard: b.getCardByIndex(e),
              iValue: 2,
            })
          : b.getCardByIndex(e).getFotogram() === FOTOGRAM_DRAW_FOUR &&
            d.push({
              oCard: b.getCardByIndex(e),
              iValue: 1,
            })
        : 12 === b.getCardByIndex(e).getRank()
        ? d.push({
            oCard: b.getCardByIndex(e),
            iValue: 6,
          })
        : 10 === b.getCardByIndex(e).getRank()
        ? d.push({
            oCard: b.getCardByIndex(e),
            iValue: 5,
          })
        : 11 === b.getCardByIndex(e).getRank()
        ? d.push({
            oCard: b.getCardByIndex(e),
            iValue: 4,
          })
...
function CUnoController() {
  ...
  this.addEventListener = function (k, g, n) {
    a[k] = g;
    b[k] = n;
  };
...
function CSummaryPanel(a) {
  ...
  this._init = function () {
    ...
    d = [];
    for (var l = 0; l < z; l++)
      (d[l] = new CPlayerInfo(0, 0, r, "szPlayerName")),
        d[l].setPosition(0, -v / 2 + (v / (z - 1)) * l, BOTTOM);
    f = "#35bd1b";
    ...
    x.addEventListener(ON_MOUSE_DOWN, this._onNext, this);
    x.pulseAnimation();
  };
  this.unload = function () {
    x.unload();
  ...
  this.setAndShow = function (v, z, l) {
    for (var E = 0; E < d.length; E++)
      if (
        (d[E].setName(v[E].name),
        d[E].setScore(v[E].score + " /" + GAME_SCORE_WIN),
        v[E].index === z)
      ) {
